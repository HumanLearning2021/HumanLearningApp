...
class LearningDatasetSelectionActivity : AppCompatActivity() {
    companion object {
        const val EXTRA_SELECTED_DATASET =
            "com.github.HumanLearning2021.HumanLearningApp.view.SELECTED_DATASET"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dsListFragment =
            supportFragmentManager.findFragmentById(R.id.LearningDatasetSelection_dataset_list)
